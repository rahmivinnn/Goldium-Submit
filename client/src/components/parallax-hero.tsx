...
export const ParallaxHero: React.FC<ParallaxHeroProps> = ({ children }) => {
  ...
  return (
    <div ref={heroRef} className="relative overflow-hidden">
      ...
      />
      <div 
        className="absolute top-40 right-20 w-1 h-1 bg-amber-400/50 rounded-full animate-pulse-custom opacity-40"
        style={{
          ...
          <div className="text-center space-y-12">
            ...
            >
              <h1 className="text-8xl md:text-9xl lg:text-[12rem] font-black leading-none tracking-tighter">
                ...
                <span className="inline-block animate-letter-float bg-gradient-to-r from-yellow-400 via-amber-400 to-orange-400 bg-clip-text text-transparent" style={{animationDelay: '0.1s'}}>O</span>
                ...
                <span className="inline-block animate-letter-float bg-gradient-to-r from-yellow-400 via-amber-400 to-orange-400 bg-clip-text text-transparent" style={{animationDelay: '0.4s'}}>I</span>
            ...
            >
              ...
              <div 
                className="flex items-center space-x-3 text-gray-300 hover-glow px-4 py-2 rounded-full border border-amber-500/30 backdrop-blur-sm hover:border-amber-400/50 transition-all duration-300 cursor-pointer"
                style={{
                  transform: `translate(${mousePosition.x * -2}px, ${mousePosition.y * 3}px)`
                }}
              >
                <Shield className="w-6 h-6 text-amber-400 animate-pulse-custom" />
                <span className="font-medium">Secure</span>
              </div>
              <div 
                className="flex items-center space-x-3 text-gray-300 hover-glow px-4 py-2 rounded-full border border-orange-500/30 backdrop-blur-sm hover:border-orange-400/50 transition-all duration-300 cursor-pointer"
                style={{
